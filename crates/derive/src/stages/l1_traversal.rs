...
pub(crate) mod tests {
    ...
    use soon_primitives::system::{CONFIG_UPDATE_EVENT_VERSION_0, CONFIG_UPDATE_TOPIC};
    ...
    pub(crate) fn new_test_traversal(
        ...
        L1Traversal::new(provider, Arc::new(rollup_config), SystemConfig::default())
    }
