...
macro_rules! multiplexed_stage {
    (
            ...
            P: $prev_type + OriginAdvancer + OriginProvider + SignalReceiver + Debug,
        {
            ...
            cfg: alloc::sync::Arc<soon_primitives::rollup_config::SoonRollupConfig>,
            ...
            P: $prev_type + OriginAdvancer + OriginProvider + SignalReceiver + Debug,
        {
            ...
            pub const fn new(cfg: alloc::sync::Arc<soon_primitives::rollup_config::SoonRollupConfig>, prev: P$( $(, $field_name: $field_type)+ )?) -> Self {
                Self {
                    cfg,
                    prev: Some(prev),
                    active_stage: None,
        ...
        where
            P: $prev_type + OriginAdvancer + OriginProvider + SignalReceiver + Debug,
        {
            fn origin(&self) -> Option<soon_primitives::blocks::BlockInfo> {
