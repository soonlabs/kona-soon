...
fn is_channel_assembler_active() -> bool {
    false
}
...
multiplexed_stage!(
    ...
    stages: {
        ChannelAssembler => is_channel_assembler_active,
    }
...
mod test {
    ...
    use crate::{
        ...
        traits::SignalReceiver, types::ResetSignal,
    };
    use alloc::sync::Arc;
    ...
    //     };
    //     stage.prev.block_info = Some(BlockInfo {
    //         number: 1,
    //         timestamp: 2,
    //         ..Default::default()
    //     });
